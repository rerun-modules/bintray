...
# Created: Tue Oct 10 22:42:18 CDT 2017
#
#/ usage: bintray:package-update  --user <>  --org <>  --package <>  --repo <>  --labels <>  --description <>  --apikey <> 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --labels) rerun_option_check $# $1; LABELS=$2 ; shift 2 ;;
